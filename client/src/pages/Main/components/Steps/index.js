...
function Steps({walletState, walletActions}) {
  return (
    <div className={styles.steps}>
      <div className={styles.header}>FOLLOW THE STEPS TO USE OUR APPLICATION</div>
      <div className={styles.body}>
        <Step index={1} title={'Connection'} image={Step1Logo} content={Step1Content} isDisabled={walletState.address} />
        <Step index={2} title={'You are ready!'} image={Step2Logo} content={Step2Content} isDisabled={!walletState.address}/>
