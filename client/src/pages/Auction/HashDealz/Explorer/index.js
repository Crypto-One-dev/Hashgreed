        ...
        <div className = {styles.explorer}>
            ...
            </div>
            {
                ...
                <div className = {styles.auctionarea}>
                    <Auction title={'Live Auction'} auctionType={'HashDealz'} auction={'live'} data={auctions.live} height={height} />
                </div>
            }
            {
                auctions && auctions.live && auctions.expired.length > 0 &&
                <div className = {styles.expiredarea}>
                    <Auction title={'Expired Auction'} auctionType={'HashDealz'} auction={'expired'} data={auctions.expired} height={height} />
                </div>
            }
            {
