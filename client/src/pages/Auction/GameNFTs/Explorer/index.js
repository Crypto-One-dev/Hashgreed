        ...
        <div className = {styles.explorer}>
            ...
            </div>
            {
                ...
                <div className = {styles.auctionarea}>
                    <Auction title={'Live Auction'} auctionType={'GameNFTs'} auction={'live'} data={auctions.live} height={height} />
                </div>
            }
            {
                auctions && auctions.live && auctions.expired.length > 0 &&
                <div className = {styles.expiredarea}>
                    <Auction title={'Expired Auction'} auctionType={'GameNFTs'} auction={'expired'} data={auctions.expired} height={height} />
                </div>
            }
            {
                auctions && auctions.live && auctions.soldout.length > 0 &&
                <div className = {styles.soldoutarea}>
                    <Auction title={'Soldout/Withdrawn Auction'} auctionType={'GameNFTs'} auction={'soldout'} data={auctions.soldout} height={height} />
                </div>
            }
        </div>
    )
