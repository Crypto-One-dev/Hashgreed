        ...
        <div className = {styles.explorer}>
            ...
            </div>
            {
                ...
                <div className = {styles.auctionarea}>
                    <Auction title={'Live Auction'} auctionType={'MusicEventsNFTs'} auction={'live'} data={auctions.live} height={height} customer={walletState.address} />
                </div>
            }
            {
                auctions && auctions.live && auctions.expired.length > 0 &&
                <div className = {styles.expiredarea}>
                    <Auction title={'Expired Auction'} auctionType={'MusicEventsNFTs'} auction={'expired'} data={auctions.expired} height={height} customer={walletState.address} />
                </div>
            }
            {
                auctions && auctions.live && auctions.soldout.length > 0 &&
                <div className = {styles.soldoutarea}>
                    <Auction title={'Soldout/Withdrawn Auction'} auctionType={'MusicEventsNFTs'} auction={'soldout'} data={auctions.soldout} height={height} customer={walletState.address} />
                </div>
            }
        </div>
    )
